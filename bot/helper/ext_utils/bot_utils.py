...
def get_readable_message():
    msg = "<b>𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐛𝐲「<a url="https://t.me/Starzleech">Star_Leech</a>」 </b>\n\n"
    button = None
...
async def checking_access(user_id, button=None):
    ...
    if not token_timeout or bool(user_id == OWNER_ID or user_id in user_data and user_data[user_id].get('is_auth')):
        return None, button
